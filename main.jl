...
OCPForm = ConfigurePredefined(ocp; (:Np=>11), (:tfDV => true), (:IntegrationScheme=>:trapezoidal), (:dx => ThreeDOFBicycle_expr), (:cons => ThreeDOFBicycle_cons), (:expr=>ThreeDOFBicycle_cost))
OCPdef!(ocp, OCPForm)
